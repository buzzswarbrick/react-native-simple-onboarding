...
<Onboarding
  pages={[
    { backgroundColor: '#fff', image: <Square />, title: 'Simple Messenger UI', subtitle: 'Implemented in React Native', titleStyle: {...styles object }, subtitleStyle: { ...styles object }},,
    { backgroundColor: "#fe6e58", image: <Circle />, title: 'Welcome', subtitle: 'To Earth', titleStyle: {...styles object }, subtitleStyle: { ...styles object }},
    { backgroundColor: "#999", image: <Square />, title: 'Also', subtitle: 'Mars is nice', titleStyle: {...styles object }, subtitleStyle: { ...styles object }},
  ]}
  onEnd={}
/>
```
...
* `pages` (required): an array of onboarding pages. A page is an object of shape:
  ...
  * `titleStyle` (required): an object titleStyle
  * `subtitleStyle` (required): am object subtitleStyle style
